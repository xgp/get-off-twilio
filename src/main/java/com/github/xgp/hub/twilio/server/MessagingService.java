...
public class MessagingService extends DefaultAccountsApiService {
  ...
  public Response accountsAccountSidMessagesmediaTypeExtensionPost(
    ...
    log.info("accountsAccountSidMessagesmediaTypeExtensionPost -> to:{}, from:{}, body:{}", to, from, body);
    ...
    try {
      ...
      Message message = new Message()
                        ...
                        .status("sent")
                        .uri(String.format("/2010-04-01/Accounts/%s/Messages/%s.json", accountSid, response.getTicketId()));
  ...
  public Response accountsAccountSidMessagesMessageSidmediaTypeExtensionGet(
      ...
      String messageSid,
      SecurityContext securityContext) {
    log.info("accountsAccountSidMessagesMessageSidmediaTypeExtensionGet -> messageSid:{}", messageSid);
    ...
    try {
      ...
      Message message = new Message()
                        ...
                        .uri(String.format("/2010-04-01/Accounts/%s/Messages/%s.json", accountSid, dlr.getTicketId()));
