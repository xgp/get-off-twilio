...
public class Members {
  ...
  private java.util.List<Object> queueMembers = null;
  ...
  public Members end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public Members firstPageUri(String firstPageUri) {
  ...
  public Members lastPageUri(String lastPageUri) {
  ...
  public Members nextPageUri(String nextPageUri) {
  ...
  public Members numPages(Integer numPages) {
  ...
  public Members page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  public Members pageSize(Integer pageSize) {
  ...
  public Members previousPageUri(String previousPageUri) {
  ...
  public Members queueMembers(java.util.List<Object> queueMembers) {
    this.queueMembers = queueMembers;
    return this;
  }

  public Members addQueueMembersItem(Object queueMembersItem) {
    if (this.queueMembers == null) {
      this.queueMembers = new java.util.ArrayList<>();
    }
  ...
  @JsonProperty("queue_members")
  @Schema(description = "")
  public java.util.List<Object> getQueueMembers() {
    return queueMembers;
  }

  public void setQueueMembers(java.util.List<Object> queueMembers) {
    this.queueMembers = queueMembers;
  }

  public Members start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public Members total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.end, members.end)
        && Objects.equals(this.firstPageUri, members.firstPageUri)
        && Objects.equals(this.lastPageUri, members.lastPageUri)
        && Objects.equals(this.nextPageUri, members.nextPageUri)
        && Objects.equals(this.numPages, members.numPages)
        && Objects.equals(this.page, members.page)
        && Objects.equals(this.pageSize, members.pageSize)
        && Objects.equals(this.previousPageUri, members.previousPageUri)
        && Objects.equals(this.queueMembers, members.queueMembers)
        && Objects.equals(this.start, members.start)
        && Objects.equals(this.total, members.total)
        && Objects.equals(this.uri, members.uri);
  }
