...
public class Credentials {
  ...
  private java.util.List<Object> credentials = null;
  ...
  public Credentials credentials(java.util.List<Object> credentials) {
  ...
  public Credentials addCredentialsItem(Object credentialsItem) {
    if (this.credentials == null) {
      this.credentials = new java.util.ArrayList<>();
    }
  ...
  @JsonProperty("credentials")
  @Schema(description = "")
  public java.util.List<Object> getCredentials() {
    return credentials;
  }

  public void setCredentials(java.util.List<Object> credentials) {
    this.credentials = credentials;
  }

  public Credentials end(BigDecimal end) {
    this.end = end;
    return this;
  }
  ...
  public Credentials firstPageUri(String firstPageUri) {
  ...
  public Credentials lastPageUri(String lastPageUri) {
  ...
  public Credentials nextPageUri(Object nextPageUri) {
  ...
  public Credentials numPages(BigDecimal numPages) {
  ...
  public Credentials page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  public Credentials pageSize(BigDecimal pageSize) {
  ...
  public Credentials previousPageUri(Object previousPageUri) {
  ...
  public Credentials start(BigDecimal start) {
    this.start = start;
    return this;
  }
  ...
  public Credentials total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public Credentials uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.credentials, credentials.credentials)
        && Objects.equals(this.end, credentials.end)
        && Objects.equals(this.firstPageUri, credentials.firstPageUri)
        && Objects.equals(this.lastPageUri, credentials.lastPageUri)
        && Objects.equals(this.nextPageUri, credentials.nextPageUri)
        && Objects.equals(this.numPages, credentials.numPages)
        && Objects.equals(this.page, credentials.page)
        && Objects.equals(this.pageSize, credentials.pageSize)
        && Objects.equals(this.previousPageUri, credentials.previousPageUri)
        && Objects.equals(this.start, credentials.start)
        && Objects.equals(this.total, credentials.total)
