...
public class Calls {
  @JsonProperty("calls")
  private java.util.List<Object> calls = null;
  ...
  public Calls calls(java.util.List<Object> calls) {
    this.calls = calls;
    return this;
  }

  public Calls addCallsItem(Object callsItem) {
    if (this.calls == null) {
  ...
  @JsonProperty("calls")
  @Schema(description = "")
  public java.util.List<Object> getCalls() {
    return calls;
  }

  public void setCalls(java.util.List<Object> calls) {
    this.calls = calls;
  }

  public Calls end(BigDecimal end) {
    this.end = end;
    return this;
  }
  ...
  public Calls firstPageUri(String firstPageUri) {
  ...
  public Calls lastPageUri(String lastPageUri) {
  ...
  public Calls nextPageUri(String nextPageUri) {
  ...
  public Calls numPages(BigDecimal numPages) {
  ...
  public Calls page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  public Calls pageSize(BigDecimal pageSize) {
  ...
  public Calls previousPageUri(Object previousPageUri) {
  ...
  public Calls start(BigDecimal start) {
    this.start = start;
    return this;
  }
  ...
  public Calls total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Calls calls = (Calls) o;
    return Objects.equals(this.calls, calls.calls)
        && Objects.equals(this.end, calls.end)
        && Objects.equals(this.firstPageUri, calls.firstPageUri)
        && Objects.equals(this.lastPageUri, calls.lastPageUri)
        && Objects.equals(this.nextPageUri, calls.nextPageUri)
        && Objects.equals(this.numPages, calls.numPages)
        && Objects.equals(this.page, calls.page)
        && Objects.equals(this.pageSize, calls.pageSize)
        && Objects.equals(this.previousPageUri, calls.previousPageUri)
        && Objects.equals(this.start, calls.start)
        && Objects.equals(this.total, calls.total)
        && Objects.equals(this.uri, calls.uri);
  }
