...
public class Transcriptions {
  ...
  private java.util.List<Object> transcriptions = null;

  @JsonProperty("uri")
  private String uri = null;

  public Transcriptions end(BigDecimal end) {
    this.end = end;
    return this;
  }
  ...
  public Transcriptions firstPageUri(String firstPageUri) {
  ...
  public Transcriptions lastPageUri(String lastPageUri) {
  ...
  public Transcriptions nextPageUri(String nextPageUri) {
  ...
  public Transcriptions numPages(BigDecimal numPages) {
  ...
  public Transcriptions page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  public Transcriptions pageSize(BigDecimal pageSize) {
  ...
  public Transcriptions previousPageUri(Object previousPageUri) {
  ...
  public Transcriptions start(BigDecimal start) {
    this.start = start;
    return this;
  }
  ...
  public Transcriptions total(BigDecimal total) {
    this.total = total;
    return this;
  }
  ...
  public Transcriptions transcriptions(java.util.List<Object> transcriptions) {
    this.transcriptions = transcriptions;
    return this;
  }

  public Transcriptions addTranscriptionsItem(Object transcriptionsItem) {
    if (this.transcriptions == null) {
      this.transcriptions = new java.util.ArrayList<>();
    }
  ...
  @JsonProperty("transcriptions")
  @Schema(description = "")
  public java.util.List<Object> getTranscriptions() {
    return transcriptions;
  }

  public void setTranscriptions(java.util.List<Object> transcriptions) {
    this.transcriptions = transcriptions;
  }

  public Transcriptions uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Transcriptions transcriptions = (Transcriptions) o;
    return Objects.equals(this.end, transcriptions.end)
        && Objects.equals(this.firstPageUri, transcriptions.firstPageUri)
        && Objects.equals(this.lastPageUri, transcriptions.lastPageUri)
        && Objects.equals(this.nextPageUri, transcriptions.nextPageUri)
        && Objects.equals(this.numPages, transcriptions.numPages)
        && Objects.equals(this.page, transcriptions.page)
        && Objects.equals(this.pageSize, transcriptions.pageSize)
        && Objects.equals(this.previousPageUri, transcriptions.previousPageUri)
        && Objects.equals(this.start, transcriptions.start)
        && Objects.equals(this.total, transcriptions.total)
        && Objects.equals(this.transcriptions, transcriptions.transcriptions)
        && Objects.equals(this.uri, transcriptions.uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class Transcriptions {\n");
